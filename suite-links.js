(function(){
  function add(){
    ...
    [['visual-project.html','شوروم پروژه'],['project-control.html','کنترل پروژه'],['import.html','ورود اکسل / Google Sheets']].forEach(function(x){const a=document.createElement('a');a.href=x[0];a.textContent=x[1];a.style=css;wrap.appendChild(a)});
